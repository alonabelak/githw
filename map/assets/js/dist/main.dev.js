...
map_link.addEventListener('click', function () {
  ...
  var marker = L.marker([50.47710696984148, 30.447275315685832]).addTo(map).bindPopup('Where I live');
  L.marker([50.447618485716916, 30.52537785491277]).addTo(map).bindPopup('Centre');
  L.marker([50.46603382386226, 30.515764817803362]).addTo(map).bindPopup('Podil');
  L.marker([50.45738028659234, 30.512191948216667]).addTo(map).bindPopup('Пейзажная алея');
  L.marker([50.49534337443858, 30.360859435480368]).addTo(map).bindPopup('Shopping mall');
  L.marker([50.48581467478758, 30.497509286604533]).addTo(map).bindPopup('Book shop');
  L.marker([50.44936719191061, 30.513358583222562]).addTo(map).bindPopup('Golden Gates');
  map_link.remove();
  map_pic.remove();
});
